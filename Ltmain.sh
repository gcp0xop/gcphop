...
clear
printf "\n${RED}${BOLD}🚀 ALPHA${YELLOW}0x1 ${BLUE}THE END GAME ${PURPLE}(${CYAN}Max Stable${PURPLE})${RESET}\n"
printf "${PURPLE}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━${RESET}\n"
...
# =================== 4. Deploying ===================
echo ""
echo -e "${YELLOW}➤ Deploying Ultimate Stable Server...${RESET}"

gcloud services enable run.googleapis.com --quiet >/dev/null 2>&1

# Deploy Command (4 vCPU / 4 GB - The Best Stability)
# 🔥 GOMAXPROCS=4 (Use all cores)
# 🔥 GOMEMLIMIT=3600MiB (Use all RAM)
# 🔥 No-Throttling (Always Active)
...
# 🔥 Force Traffic 
echo -e "${YELLOW}➤ Clearing Old Connections...${RESET}"
